...
// Sur un téléphone, la navigation visible est la barre d'onglets fixe en bas
// (.nav du haut est réservée au grand écran, display:none ici).
await page.click('.tabbar a[href="simulateur.html"]');
